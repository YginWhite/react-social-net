...
const ProfileInfo = (props) => {
	...
	return (
		<div className={clss.profileInfo}>
			<figure className={clss.profileInfo_pict}>
				<p>
					{
			...
			<div className={clss.profileInfo_about}>
				<ul className={clss.profileInfo_about_list}>
					...
					<li className={clss.profileInfo_about_listItem}>
						<span>Contacts:</span>
						<ul className={clss.profileInfo_about_contacts}>
							{

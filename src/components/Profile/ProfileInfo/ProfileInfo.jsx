...
const iconsName = {
	...
	github: 'github',
	instagram: 'instagram',
	mainLink: 'location-arrow',
	twitter: 'twitter',
	vk: 'vk',
	website: 'location-arrow',
	youtube: 'youtube'
};
		...
		<div>
			...
			<div className={style.profile_container}>
				...
				<ul className={style.profile_about}>
					...
					<li>
						<span>Status:</span>&nbsp;
						<span><ProfileInfoStatus status={props.status} changeStatus={props.changeStatus}/></span>
					</li>

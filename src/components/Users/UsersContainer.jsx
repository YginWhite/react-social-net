...
import { follow, unfollow,  changePagesRange, getUsers, changePage } from './../../redux/usersReducer';
...
export default compose(
	connect(mapStateToProps, {follow, unfollow, changePagesRange, getUsers, changePage }),
	withAuthRedirect
)(UsersContainer);